...
export const queueOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'Pause', value: 'pause', action: 'Pause the queue', description: 'Pause processing, global or per account (requires Pro)' },
			{ name: 'Resume', value: 'resume', action: 'Resume the queue', description: 'Resume processing, global or per account (requires Pro)' },
			{ name: 'Retry Batch', value: 'retryBatch', action: 'Retry a batch', description: 'Retry all failed items in a batch (requires Pro)' },
			{ name: 'Retry Item', value: 'retryItem', action: 'Retry an item', description: 'Reset a failed item to pending (requires Pro)' },
		],
		default: 'enqueue',
	},
];
